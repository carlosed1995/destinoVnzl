...
{!!Form::open(['route' => 'certificados.store', 'method' => 'post', 'files' => true])!!}										
	<script src="/../public/js/solonumeros.js"></script>
<div class="form-group">
 <label>Nombre</label>
			<input type="text" name="txtnombre" placeholder="Ingrese nombre " id="" class="form-control" >
</div>
		<div class="form-group">

			<label>Direccion</label>
			<input type="text" name="txtdireccion" placeholder="Ingrese dirección " id="" class="form-control" >
		</div>
		<div class="form-group">
...
<div class="form-group">
<input type="text" name="titulo1" placeholder="Título del texto" id="" class="form-control" >
