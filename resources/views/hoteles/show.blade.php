                    ...
                    <tbody>
                     <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                        	<br>
                <h4 class="epsilon u-tight-bottom">Estrellas</h4>
                <br>
						<?php
						/*echo "<pre>";
						print_r($pruebahotel);
						echo "</pre>";*/
						$count = $pruebahotel->estrellas;
						if($pruebahotel->estrellas>=1){
						echo "<div class='lodging-services lodging-search-services-services'>";
						for($x=1; $x <= $count;$x++){
						echo "<img src='/../public/imagenes/estrella.png' data-original-title='Estrellas'  data-toggle='tooltip' data-placement='bottom'>";
						}
						echo "</div>";
						}
						?>
                        ...
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                              <p class="delta text-weight-normal"><?php echo ucwords(strtolower($pruebahotel->Estado)); ?> </p>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                              <p class="delta text-weight-normal"><?php echo ucwords(strtolower($pruebahotel->Ciudad)); ?></p>
                          </div>
                        </td>
                      </tr>
                      <?php 
                      ...
                      ?>
                       <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                              <p class="delta text-weight-normal"><?php echo ucwords(strtolower($pruebahotel->Zona)); ?></p>
                          </div>
                        </td>
                      </tr>
                     ...
                     // }
                      ...
                      <tr>
						<td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                            <p class="delta text-weight-normal">{{$pruebahotel->direccion}}</p>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <p class="delta text-weight-normal c-feature-table__span-double" itemprop="value">Tlf: {{$pruebahotel->telefono}}</p>
                        </td>
                      </tr>
                     <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                <h4 class="epsilon u-tight-bottom">Servicios del Hotel</h4>
                <br>
               <div class="lodging-services lodging-search-services-services">
                  @foreach($tiposerv as $servicio)
            		...
            		@if (Auth::guest()) 
						...
						@else
						<div class="action">
						<button  type="button" id='submitCreate' value="Reservar" class="btn btn-info btn-lg mostrarModal" class="button" id='{{$pruebahotel->id}}' data-user="{{Auth::user()->name}}" data-title="Edit" data-id="{{$pruebahotel->id}}" data-nombre="{{$pruebahotel->nombre}}" data-direccion="{{$pruebahotel->direccion}}" data-url="{{$pruebahotel->url}}" data-horario="{{$pruebahotel->horario}}" data-descripcion="{{$pruebahotel->descripcion}}"  data-descuento="{{$pruebahotel->descuento}}" data-toggle="modal" type="button">Reservar</button>
						</div>
					@endif
                        </td>
                      </tr>
