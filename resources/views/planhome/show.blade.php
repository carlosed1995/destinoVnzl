                  ...
                  <table class="c-feature-table c-feature-table--two-column c-feature-table--padded-mobile">
                    <tbody>
                        ...
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                              <p class="delta text-weight-normal"><?php echo ucwords(strtolower($planes->Estado)); ?> </p>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                              <p class="delta text-weight-normal"><?php echo ucwords(strtolower($planes->Ciudad)); ?></p>
                          </div>
                        </td>
                      </tr>
                      <?php 
                      ...
                      ?>
                       <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                              <p class="delta text-weight-normal"><?php echo ucwords(strtolower($planes->Zona)); ?></p>
                          </div>
                        </td>
                      </tr>
                     ...
                     // }
                      ...
                      <tr>
						<td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                            <p class="delta text-weight-normal">{{$planes->direccion}}</p>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <p class="delta text-weight-normal c-feature-table__span-double" itemprop="value">Tlf: {{$planes->telefono}}</p>
                        </td>
                      </tr>
            		...
            		@if (Auth::guest()) 
						...
						@else
						<div class="action">
						<button  type="button" id='submitCreate' value="Reservar" class="btn btn-info btn-lg mostrarModal" class="button" id='{{$planes->id}}' data-user="{{Auth::user()->name}}" data-title="Edit" data-id="{{$planes->id}}" data-nombre="{{$planes->nombre}}" data-direccion="{{$planes->direccion}}"   data-descuento="{{$planes->costos}}" data-toggle="modal" type="button">Reservar</button>
						</div>
					@endif
                        </td>
                      </tr>
