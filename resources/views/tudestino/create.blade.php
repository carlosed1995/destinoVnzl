...
{!!Form::open(['route' => 'tudestinos.store', 'method' => 'POST', 'files' => true])!!}										
...
<div class="form-group">
<label>Fecha Inicial:
<input type="text" data-date-format='yyyy-mm-dd' name="fechaini"  id="select" class="form-control col-lg-8" required></div>

<div class="form-group">
<label>Fecha Final:
<input type="text" data-date-format='yyyy-mm-dd' name="fechafin"  id="select1" class="form-control col-lg-8" required></div>  

<br>
<br>

<div class="form-group">
<label>Número de paquetes disponibles:
<input type="text"  name="paquetes"  id="paquetes" class="form-control col-lg-8" placeholder="Escriba el numero de paquetes en número"></div>  
