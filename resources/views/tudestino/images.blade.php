...
<div class="action">
<button id='submitCreate' type="button" value="Reservar" class="btn btn-warning mostrarModal" class="button" id='{{$destinos->id}}' data-title="Edit" data-id="{{$destinos->id}}"  data-toggle="modal" type="button">Agregar imagen</button>
 </div>
