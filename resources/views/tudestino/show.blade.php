			...
			<div class="tab-content">
			   <div class="tab-pane active" id="tab_a">
					<div class="l-section l-section--bordered l-section--padded l-section--tight l-section--flush-mobile u-text-align-center">
	                  <table class="c-feature-table c-feature-table--two-column c-feature-table--padded-mobile">
						...
						<td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                              <p class="delta text-weight-normal"><?php echo ucwords(strtolower($escapes->Estado)); ?> </p>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                              <p class="delta text-weight-normal"><?php echo ucwords(strtolower($escapes->Ciudad)); ?></p>
                          </div>
                        </td>
                      </tr>
                      <?php 
                      ...
                      ?>
                       <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                              <p class="delta text-weight-normal"><?php echo ucwords(strtolower($escapes->Zona)); ?></p>
                          </div>
                        </td>
                      </tr>
                     ...
                     // }
                      ...
                      <tr>
						<td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <div itemprop="value">
                            <p class="delta text-weight-normal">{{$escapes->direccion}}</p>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                          ...
                          <p class="delta text-weight-normal c-feature-table__span-double" itemprop="value">Tlf: {{$escapes->telefono}}</p>
                        </td>
                      </tr>
            		...
            		@if (Auth::guest()) 
						...
						@else
						<div class="action">
						<button  type="button" id='submitCreate' value="Reservar" class="btn btn-info btn-lg mostrarModal" class="button" id='{{$escapes->id}}' data-user="{{Auth::user()->name}}" data-title="Edit" data-id="{{$escapes->id}}" data-nombre="{{$escapes->nombre}}" data-direccion="{{$escapes->direccion}}"   data-descuento="{{$escapes->descuento}}" data-toggle="modal" type="button">Reservar</button>
						</div>
					@endif
                        </td>
                      </tr>
